    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full about-page">
        ...
        <p className="text-xl mt-20">
          ...
          journey has taken me across borders and cultures, spanning from China
          to Russia, and eventually leading me to the enchanting town of Kampot.
          Since 2018, I've been passionately imparting knowledge in the realms
          of English and Math, channeling my expertise across diverse
          international settings. As I guided eager minds through the
          intricacies of these subjects, I found myself drawn to the captivating
